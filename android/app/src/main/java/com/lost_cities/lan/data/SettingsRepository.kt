package com.lost_cities.lan.data
...
private const val DATASTORE_NAME = "lost_cities_lan_settings"
...
class SettingsRepository(private val context: Context) {
    ...
    private val keyAiHelpEnabled = booleanPreferencesKey("ai_help_enabled")
    ...
    val settings: Flow<AppSettings> = context.dataStore.data.map { prefs ->
        ...
        AppSettings(
            ...
            aiHelpEnabled = prefs[keyAiHelpEnabled] ?: false,
    ...
    suspend fun initializeDefaultsIfNeeded() {
        context.dataStore.edit { prefs ->
            ...
            prefs[keyAiHelpEnabled] = prefs[keyAiHelpEnabled] ?: false
    ...
    suspend fun save(
        ...
        context.dataStore.edit { prefs ->
            ...
            prefs[keyAiHelpEnabled] = aiHelpEnabled
